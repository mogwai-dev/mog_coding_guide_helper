...
## include パスを設定ファイルから設定できるようにする(2025/12/18 済)

## include ディレクトリがプロジェクトルートにない場合は診断で警告をする(2025/12/18 済)

## src ディレクトリがプロジェクトルートにない場合は診断で警告をする(2025/12/18 済)

## コーディング規約を適用しないファイルを指定できるようにする(2025/12/18 済)
